    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('content', models.TextField()),
                ('read', models.CharField(choices=[('Y', 'Y'), ('N', 'N')], default='N', max_length=3)),
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('url', models.CharField(default='', max_length=255)),
                ('receiver_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myApp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('complete_time', models.DateTimeField(default='2050-12-31')),
                ('option', models.CharField(choices=[('B', 'B'), ('A', 'A')], default=None, max_length=1, null=True)),
                ('project_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myApp.project')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myApp.user')),
            ],
        ),
