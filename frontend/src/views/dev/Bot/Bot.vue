                    ...
                    <el-table :data="rules" stripe>
                        ...
                        <el-table-column label="操作" width="180">
                            <template slot-scope="scope">
                                ...
                                <el-button size="mini" type="danger" @click="deleteRule(scope.$index)" class="el-button-delete">删除</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    </el-card>
                    ...
                    <el-card class="box-card" id="labels-section">
                        ...
                        <el-table :data="labels" stripe>
                            ...
                            <el-table-column label="操作" width="180">
                                ...
                                <el-button size="mini" type="danger" @click="deleteLabel(scope.$index)" class="el-button-delete">删除</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                    </el-card>
