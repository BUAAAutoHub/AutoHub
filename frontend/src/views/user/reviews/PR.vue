...
<div style="margin: 15px">
  ...
  <v-row class="align-center" style="margin: 20px 0 20px 20px">
        <!-- 左侧标题 -->
        <h1 style="margin: 0; font-size: 24px"><v-chip label >!{{this.prId}}</v-chip>  {{this.prDetail.title}}</h1>
        ...
        <span style="margin-left: 5px">生成分享链接</span>
        </el-button>
    </v-row>

    <!-- 分享链接 -->
    <el-dialog title="分享PR评审" :visible.sync="shareDialog" width="40%">
        <el-form>
